...
func numberOfCompromisedAgents() -> Int {
    var numOfAgents = 0
...
let numOfCleanAgents: Int = findCleanAgents().count

print(String(numOfCleanAgents) + " clean agents out of " + String(agents.count) + " total agents.")
//: ## Step 7
...
func numberOfAgentsInLevels() {
    
    var lowLevelAgents: Int = 0
    var midLevelAgents: Int = 0
    var highLevelAgents: Int = 0
